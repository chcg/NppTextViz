...
void commandMenuInit()
{
	...
	setCommand(11, TEXT("Copy entire selection"), doCopyAll, NULL, false);
	...
	setCommand(14, TEXT("Cut entire selection"), doCutAll, NULL, false);
	...
	setCommand(17, TEXT("Delete entire selection"), doDelAll, NULL, false);
	...
	setCommand(20, TEXT("Append entire selection"), doAppendAll, NULL, false);
